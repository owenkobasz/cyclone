const { generateGPTRoute, parseWaypointsFromGPT } = require('./services/gptPromptIntegration');
const { getValhallaRoute } = require('./services/valhallaRequest');
const { getGraphHopperRoute, formatGraphHopperResponse } = require('./services/graphHopperRequest');
const { getOpenElevation } = require('./services/openElevationRequest');
