      ...
      <div className="absolute inset-0 bg-black opacity-50" aria-hidden="true"></div>
       ...
       <div className="z-10 text-center w-full max-w-2xl mx-auto px-4">
         <div className="w-full bg-white/20 backdrop-blur-sm p-8 border border-white/30 rounded-xl shadow-md">
           <Header level={1} className="text-3xl font-bold">Welcome to Cyclone!</Header>
           <ButtonGradient />
           ...
           <div className="mt-6 space-x-4">
               ...
               <Link to="/map" className="px-4 py-2 text-2xl font-bold text-white !text-white bg-blue-500/20 border border-2 border-white hover:bg-blue-500 hover:underline rounded transition-colors">Log In</Link>
           </div>
